  ...
  return (
    <nav className="bg-white p-2 w-full fixed top-0 left-0 right-0">
      <div className="container mx-auto flex justify-between items-center ">
        ...
        <Link href="/register" className='text-yellow-400  hover:bg-yellow-500 hover:text-white px-4 py-2 rounded font-bold'
          >
            Register
          </Link>
        ...
        <div>
          <ul className="flex space-x-4">
            <li className='bg-yellow-400 px-3 py-2 rounded-full hover:bg-yellow-500 hover:text-white'>
